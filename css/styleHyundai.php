...
/*    -webkit-box-shadow: inset 0px 0px 30px 16px rgba(50, 50, 50, 1);  -moz-box-shadow:    inset 0px 0px 30px 16px rgba(50, 50, 50, 1);  
    box-shadow: inset 69px 8px 30px 16px rgb(2, 2, 2);
    -webkit-box-shadow: inset 0px -1px 20px 16px rgba(0, 0, 0, 1);  -moz-box-shadow:    inset 0px -1px 20px 16px rgba(0, 0, 0, 1);  box-shadow:         inset 0px -1px 20px 16px rgba(0, 0, 0, 1);*/
    /* position: initial; */
    /* margin-left: -1%; */
    margin-top: 10px;
    width: 87.5%;
...
.modal-header-compartir {
    ...
    padding: 15px;
    /* border-bottom: 1px solid #138913; */
    padding-bottom: 33px;
}
