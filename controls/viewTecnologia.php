...
<div class="col-md-12 text-center" id="divBtnCampanaTit">
    <a class="btn btn-default btn-lg" id="btnTecnologia"><?php echo $rowSeccion4["titulo_texto_seccion_4"]; ?></a>
    <hr id="hr">
</div>
<div class="section">
    <div class="container">
        <div class="row" id="rowImgTextTecnologiaSi">
            <div class="col-md-6">
                <img class="img-responsive" id="textTecnologia" src="<?php echo $rowSeccion4["imagen_1_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai"/>
            </div>
            <div class="col-md-6">
                <img class="img-responsive" id="imgTecnologia" src="<?php echo $rowSeccion4["imagen_2_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai"/>
            </div>
    ...
    <div class="container">
        ...
        <div id='contenedorImgTecnologia'>
            <div class="row" id="divRowImg2">
                <div class="col-md-4">
                    <img id="img-1-tecno-escritorio" src="<?php echo $rowSeccion4["contenido_1_imagen_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                    <img id="img-1-tecno-mobile" src="<?php echo $rowSeccion4["contenido_1_imagen_mobile_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                </div>
                <div class="col-md-8">
                    <h4 id="h4ContenidoTecnologia"><?php echo utf8_encode($rowSeccion4["contenido_1_titulo_texto_seccion_4"]); ?></h4>
                    <hr id="hrContenidoTecnologia">
                    <div class="contenedorP1">
                        <p id="pContenidoTecnologia">
                            <?php echo utf8_encode($rowSeccion4["contenido_1_descripcion_texto_seccion_4"]); ?>
                        </p>
                    </div> 
            ...
            <div class="row" id="divRowImg2">
                <div class="col-md-4">
                    <img id="img-2-tecno-escritorio" src="<?php echo $rowSeccion4["contenido_2_imagen_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                    <img id="img-2-tecno-mobile" src="<?php echo $rowSeccion4["contenido_2_imagen_mobile_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                </div>
                <div class="col-md-8">
                    <h4 id="h4ContenidoTecnologia"><?php echo utf8_encode($rowSeccion4["contenido_2_titulo_texto_seccion_4"]); ?></h4>
                    <hr id="hrContenidoTecnologia">
                    <div class="contenedorP2">
                        <p id="pContenidoTecnologia">
                           <?php echo utf8_encode($rowSeccion4["contenido_2_descripcion_texto_seccion_4"]); ?>
                        </p>
                    </div>
            ...
            <div class="row" id="divRowImg2">
                <div class="col-md-4">
                    <img id="img-3-tecno-escritorio" src="<?php echo $rowSeccion4["contenido_3_imagen_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                    <img id="img-3-tecno-mobile" src="<?php echo $rowSeccion4["contenido_3_imagen_mobile_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                </div>
                <div class="col-md-8">
                    <h4 id="h4ContenidoTecnologia"><?php echo utf8_encode($rowSeccion4["contenido_3_titulo_texto_seccion_4"]); ?></h4>
                    <hr id="hrContenidoTecnologia">
                    <div class="contenedorP3">
                        <p id="pContenidoTecnologia">
                            <?php echo utf8_encode($rowSeccion4["contenido_3_descripcion_texto_seccion_4"]); ?>
                        </p>
                    </div>
        ...
        <div id='contenedorImgTecnologia2'>
            <div class="row" id="divRowImg2">
                <div class="col-md-4">
                    <img id="img-4-tecno-escritorio" src="<?php echo $rowSeccion4["contenido_4_imagen_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                    <img id="img-4-tecno-mobile" src="<?php echo $rowSeccion4["contenido_4_imagen_mobile_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                </div>
                <div class="col-md-8">
                    <h4 id="h4ContenidoTecnologia"><?php echo utf8_encode($rowSeccion4["contenido_4_titulo_texto_seccion_4"]); ?></h4>
                    <hr id="hrContenidoTecnologia">
                    <div class="contenedorP4">
                        <p id="pContenidoTecnologia">
                            <?php echo utf8_encode($rowSeccion4["contenido_4_descripcion_texto_seccion_4"]); ?>
                        </p>
                    </div>
            ...
            <div class="row" id="divRowImg2">
                <div class="col-md-4">
                    <img id="img-5-tecno-escritorio" src="<?php echo $rowSeccion4["contenido_5_imagen_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                    <img id="img-5-tecno-mobile" src="<?php echo $rowSeccion4["contenido_5_imagen_mobile_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                </div>
                <div class="col-md-8">
                    <h4 id="h4ContenidoTecnologia"><?php echo utf8_encode($rowSeccion4["contenido_5_titulo_texto_seccion_4"]); ?></h4>
                    <hr id="hrContenidoTecnologia">
                    <div class="contenedorP5"><p id="pContenidoTecnologia">
                            <?php echo utf8_encode($rowSeccion4["contenido_5_descripcion_texto_seccion_4"]); ?>
                        </p>
                    </div>
            ...
            <div class="row" id="divRowImg2">
                <div class="col-md-4">
                    <img id="img-6-tecno-escritorio" src="<?php echo $rowSeccion4["contenido_6_imagen_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>
                    <img id="img-6-tecno-mobile" src="<?php echo $rowSeccion4["contenido_6_imagen_mobile_seccion_4"]; ?>" alt="EON TECH nuevo Hyundai" class="img-responsive"/>

                </div>
                <div class="col-md-8">
                    <h4 id="h4ContenidoTecnologia"><?php echo utf8_encode($rowSeccion4["contenido_6_titulo_texto_seccion_4"]); ?></h4>
                    <hr id="hrContenidoTecnologia">
                    <div class="contenedorP6"><p id="pContenidoTecnologia">
                            <?php echo utf8_encode($rowSeccion4["contenido_6_descripcion_texto_seccion_4"]); ?>
                        </p>
